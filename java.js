fetchCountries = async () => {
   ...
   function Display_elements(myJson, listbox, coloumn, page){
    ...
    for(let i= start;i<end;i++){
        ...
        var li_list = ["Population", "Region", "Capital","area","region","subregion","timezones"];
        var li_values = [myJson[i].population, myJson[i].region, myJson[i].capital,myJson[i].area,myJson[i].region ,myJson[i].subregion,myJson[i].timezones[0]];
